...
const AIR_CURRENT_KEY =
  'sOhJfqSthcEwtpqskBzX%2FkRGGoB9%2F6fdlLalUTx6ot6EACPP0xziXi5EJljSFofskyvxBg0pJ2LxhDhAsFF1Og%3D%3D';
...
function App() {
  ...
  useEffect(async () => {
    ...
    const air = await axios.get(
      `/air?serviceKey=${AIR_CURRENT_KEY}&returnType=json&numOfRows=100&pageNo=1&stationName=%EC%A4%91%EB%B6%80%EB%8C%80%EB%A1%9C(%EA%B5%AC%EA%B0%88%EB%8F%99)&dataTerm=DAILY&ver=1.0`,
    )
